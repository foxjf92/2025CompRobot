...
import frc.robot.config.RobotConfig.HangConfig;
...
public class Hang extends SubsystemBase {
    ...
    public void controlByEncoderTriggers() {
        ...
        // System.out.println("Hang: current=" + currentPosition + ", target=" + target +
    ...
    public void printEncoderValues() {
        for (MotorData md : motorDataList) {
            if (md.printEncoder) {
                System.out.println("Hang Motor CAN ID " + md.motor.getDeviceId() +
